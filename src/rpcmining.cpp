...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateNihilistcoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Nihilistcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Nihilistcoin is downloading blocks...");
