TEMPLATE = app
TARGET = nihilistcoin-qt
macx:TARGET = "Nihilistcoin-Qt"
VERSION = 0.8.5.6
...
SOURCES += src/qt/nihilistcoin.cpp \
...
macx:ICON = src/qt/res/icons/nihilistcoin.icns
